...
# Resimlerin bulunduğu dizin (LinRAR.py ile aynı dizin)
...
class LanguageManager:
    def __init__(self):
        ...
        self.default_english_translations = {
            "app_title": "LinRAR - Linux Archiver (Demo)",
            ...
            "help_topics": "Help Topics", "license_info": "License...", "about_linrar": "About LinRAR...",
            ...
            "settings_title": "LinRAR Settings",
...
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        general_layout.addRow(QLabel(lang_manager.get_text("settings_extract_path_label")), QLineEdit("~/.config/LinRAR/extracted")) # Dummy QLineEdit
...
class LinRARDummyApp(QMainWindow):
    def __init__(self):
        super().__init__()
    ...
    def init_ui(self):
        ...
        help_menu.addAction(self.create_dummy_action(lang_manager.get_text("about_linrar"), "about_linrar"))
